...
dat_post <- subset(dat, subset = Category == "POST")
dat_pre <- subset(dat, subset = Category == "PRE")

# 必要に応じてサブセット化したデータを保存
saveRDS(dat_post, file = "/home/saito_h/post.rds")
saveRDS(dat_pre, file = "/home/saito_h/pre.rds")
